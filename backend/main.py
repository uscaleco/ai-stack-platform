...
TEMPLATES = {
    "ollama-webui": {
        ...
        "pricing": {
            ...
            "enterprise": {
                "price": 15000,
                "features": ["Real-time updates", "Custom schedules", "SLA"],
            },
        },
...
async def root():
    ...
    return {
        ...
        "docs": (
            ...
            else "Contact support for API docs"
        ),
    }
...
async def get_user_profile(
    ...
    try:
        ...
        deployment_count = (
            ...
            if deployment_result.get("records")
            else 0
        )
...
async def create_subscription(
    ...
    try:
        ...
        customer = stripe.Customer.create(
            ...
            metadata={"user_id": user_id, "supabase_user": "true"},
        )
        ...
        subscription = stripe.Subscription.create(
            ...
            metadata={"user_id": user_id, "template_id": request.plan_type},
        )
        ...
        parameters = [
            ...
            {"name": "user_email", "value": {"stringValue": user_email}},
            {
                ...
                "value": {"stringValue": subscription.id},
            },
...
async def deploy_stack(
    request: DeploymentRequest, current_user: dict = Depends(get_current_user)
):
